...
module ETCS.SDM.BreakingModelConverter
       ...
       , BreakingModelInput, ConvertedBreakingModel
       , cbmEmergencyModelA, cbmServiceModelA
       , cbmEmergencyModelT, cbmServiceModelT
       ) where
...
type BreakingModelInput f = (Velocity f, BreakingPercentage f, Length f, BreakPosition)
...
data ConvertedBreakingModel f =
  ConvertedBreakingModel {
    ...
    cbmEmergencyModelA     :: A_Break f,
    cbmServiceModelA       :: A_Break f,
    cbmEmergencyModelT     :: T_Break f,
    cbmServiceModelT       :: T_Break f
    }
...
breakingModelConverter = prism'
      (\c -> (_cbmMaxVelocity c, _cbmBreakingPercentage c, _cbmTrainLength c, _cbmBreakPosition c))
      (\(vmax, lambda, l, bpos) ->
...
breakingModelConverter' vmax lamda l bpos =
  ...
  in ConvertedBreakingModel {
    ...
    cbmEmergencyModelA = ea,
    cbmServiceModelA   = sa,
    cbmEmergencyModelT = t_brake_emergency_cm bpos l,
    cbmServiceModelT   = t_brake_service_cm bpos l
    }
